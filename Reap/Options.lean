...
register_option reap.ps_endpoint : String :=
  { defValue := "https://console.siflow.cn/siflow/hercules/skyinfer/zcheng/ps2-1/retrieve_premises"
    descr := "Endpoint for the premise selection service." }

register_option reap.value_endpoint : String :=
  { defValue := "https://console.siflow.cn/siflow/hercules/skyinfer/zcheng/pvhead-1/value/v1"
...
register_option reap.policy_endpoint : String :=
  { defValue := "https://console.siflow.cn/siflow/hercules/skyinfer/zcheng/pvhead-1/policy/v1"
